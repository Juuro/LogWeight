...
6. Add a privacy policy URL in App Store Connect — `support/privacy/index.html`, published at `https://juuronina.de/LogWeight/support/privacy/` (see `docs/AppStoreMetadata.md`), using `docs/Privacy.md` as the canonical statement.
