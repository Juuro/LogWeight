...
6. Add a privacy policy URL in App Store Connect — publish `support/privacy/index.html` on Vercel (or another static HTTPS host) as `/support/privacy/`, using `docs/Privacy.md` as the canonical statement.
