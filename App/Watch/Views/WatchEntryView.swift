...
/// watchOS target-local copy used because the shared view file is not part of
/// the watch target membership.
private struct LongPressStepButton<Label: View>: View {
